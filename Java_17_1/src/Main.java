...
//      1-6. 기본 타입 스트림
        ...
        IntStream intStream = IntStream.range(1,5); // 5전까지 출력
...
//      3-1. Sum, Average
        ...
        double aver =  IntStream.range(1, 5).average().getAsDouble();
...
//      3-3. reduce
        ...
        Stream<Integer> st3 = new ArrayList<Integer>(Arrays.asList(1,2,3,4,5)).stream();
        System.out.println(st3.reduce((x, y) -> x + y).get());
