...
//        1-1. ArrayList
        ...
        list1.remove(Integer.valueOf(2)); // 그냥 2를 쓰면 인덱스2로 인식됨
        System.out.println("list1 = " + list1);
        list1.add(0, 10); // 데이터 넣을때 인덱스 위치로 데이터를 넣을수 있음
        System.out.println("list1 = " + list1);
        System.out.println("list1.size() = " + list1.size()); // list 사이즈 확인
        System.out.println("list1.contains(1) = " + list1.contains(1)); // 1이 있는지 확인하는거
        System.out.println("list1.indexOf(10) = " + list1.indexOf(10)); // 데이터 10의 인덱스 확인하는거
